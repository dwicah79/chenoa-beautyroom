...
const props = defineProps({
  ...
  phoneNumber: {
    type: String,
    default: '6282226727418',
  },
})

const whatsappUrl = computed(() => {
  const message = props.serviceName
    ? `Halo Chenoa Beauty Room!\n\nSaya ingin booking untuk layanan *${props.serviceName}*.\n\nMohon informasi lebih lanjut mengenai:\n- Harga\n- Waktu yang tersedia\n- Proses treatment\n\nTerima kasih!`
    : `Halo Chenoa Beauty Room!\n\nSaya ingin booking treatment. Mohon informasi lebih lanjut.\n\nTerima kasih!`
...
const variantClasses = computed(() => {
  const variants = {
    ...
    white:
      'bg-white text-rose-500 hover:bg-rose-50 focus:ring-rose-200 shadow-soft border border-rose-100',
  }
